...
CREATE TABLE `etherpad_pad_version`  (
  ...
  `change_content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '变更具体内容',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3459 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Pad版本数据表' ROW_FORMAT = DYNAMIC;
